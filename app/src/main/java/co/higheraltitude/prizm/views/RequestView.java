...
public class RequestView extends RelativeLayout {
    ...
    public static RequestView inflate(ViewGroup parent) {
        RequestView view = (RequestView)LayoutInflater.from(parent.getContext())
    ...
    private static class ImageHandler extends Handler {
        private String mInstanceId;
        private RequestView mPostView;
        private ImageView mImageView;
        private int mType;
        public static int POST_IMAGE_TYPE_AVATAR = 0;
        public static int POST_IMAGE_TYPE_IMAGE = 1;

        public ImageHandler(RequestView view, ImageView iv, String id, int type) {
            mInstanceId = id;
            mPostView = view;
            mImageView = iv;
            mType = type;
