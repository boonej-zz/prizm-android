 ...
 * Use the {@link TrustsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TrustsFragment extends Fragment implements AdapterView.OnItemClickListener {
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_USER_LIST = "arg_user_list";
    private ArrayAdapter<Trust> mTrustAdapter;
     ...
     */
    public static TrustsFragment newInstance() {
        TrustsFragment fragment = new TrustsFragment();
        return fragment;
    }

    public TrustsFragment() {
        // Required empty public constructor
    }

    public void setArrayAdapter(ArrayAdapter<Trust> adapter) {
        mTrustAdapter = adapter;
        if (mListView != null) {
            mListView.setAdapter(mTrustAdapter);
        }
    }
            ...
            mListView.setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                public void onScrollStateChanged(AbsListView view, int scrollState) {
                    ...
                    if (lastVisibleItem > firstPosition) {
                        ...
                        mActivity.fetchTrusts(true);

                    } else {
                        if (view.getLastVisiblePosition() >= view.getCount() - 5) {
                            NotificationFeedActivity mActivity = (NotificationFeedActivity)getActivity();
                            mActivity.fetchOlderTrusts();
                        }
                    }
